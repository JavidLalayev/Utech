    ...
    <div class="container">
        ...
        <div class="row align-items-center c-mb-20 c-mb-lg-60">
            ...
            <div class="col-12 col-lg-4">
                <div class="step-center-part text-center">
                    <img src="<?php echo base_url("public/assets_for_frontend/images/")?>step_img_1.jpg" alt="">
                </div>
            </div>
            <div class="col-12 col-lg-4">
        ...
        <div class="row align-items-center right c-mb-20 c-mb-lg-60">
            ...
            <div class="col-12 col-lg-4 order-lg-2">
                <div class="step-center-part text-center">
                    <img src="<?php echo base_url("public/assets_for_frontend/images/")?>step_img_2.jpg" alt="">
                </div>
            </div>
        ...
        <div class="row align-items-center c-mb-20 c-mb-lg-60">
            ...
            <div class="col-12 col-lg-4">
                <div class="step-center-part text-center">
                    <img src="<?php echo base_url("public/assets_for_frontend/images/")?>step_img_3.jpg" alt="">
                </div>
            </div>
            <div class="col-12 col-lg-4">
                <div class="step-right-part">
