...
<div class="page-content">
    ...
    <div class="content">
        <h1 class="c_title">Əməkdaşlıq</h1>
        <div class="grid simple ">
            <div class="row" style="margin-top: 50px">
                <div class="grid-body no-border c_grid_padding c_resfresh_portfolio_category">


                    <a href="<?php echo base_url("utech_admin_panel_partners_add")?>" class="btn btn-success c_right">
                        ...
                        <?php foreach ($partners as $partner) { ?>
                            ...
                            <tr>
                                <td class="v-align-middle c_vertical_align_middle">
                                    <?php echo $partner["link"]?>
                                </td>

                                <td class="v-align-middle c_vertical_align_middle text-center">
                                    <img width="120px" height="100px" src="<?php echo base_url("uploads/partners/".$partner["img"]) ?>" alt="Şəkil Yüklənmədi">
                                </td>
                                <td class="v-align-middle c_vertical_align_middle text-center">
                                    <a href="<?php echo base_url('utech_admin_panel_partners_update/'.$partner["id"]) ?>" class="btn btn-warning">
                                        <i class="fa fa-pencil-square-o"></i>
                                        Yenilə
                                    </a>
                                    <a href="<?php echo base_url('utech_admin_panel_partners_delete/'.$partner["id"]) ?>" class="btn btn-danger c_delete_service_category">
                                        <i class="fa fa-pencil-square-o"></i>
                                        Sil
                                    </a>
                                </td>
